        ...
        >
          ...
          <div className="fixed bottom-6 right-6 z-50">
            <Link href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="block w-14 h-14 transition-transform hover:scale-110">
                 <div style={{ clipPath: 'path("M28 3C12.536 3 0 14.1921 0 28C0 41.8079 12.536 53 28 53C22 53 20 56 17 56C16.5 52 17.5 45.3333 19.5 39.5C17.8373 36.1012 16.7876 32.1818 16 28C16 14.1921 28.536 3 28 3Z")' }}>
